export const privacyTerm = `AppCatch 서비스 이용에 따른 개인정보 수집 및 이용 동의


서비스 제공 기관인 예티소프트는 AppCatch 서비스를 제공하기 위해 다음의 개인정보를 수집 및 이용합니다.

1. 수집하는 개인정보 항목
- 필수정보 : e-mail 주소, 고객사 명, 서비스 명, 고객사 App 명
- 선택정보 : 없음
* 서비스 이용과정에서 아래 개인정보는 자동으로 생성되어 수집될 수 있습니다.
· 장치 제조사, 장치 이름, 운영환경 이름, 운영 환경 제조사, 운영환경 버전, 브랜드 명, WIFI 정보, IP 정보, GPS 정보

2. 수집 및 이용 목적
- App의 품질 향상을 위한 크래시 및 로그 정보 분석

3. 보유 및 이용기간
- 예티소프트는 수집된 개인정보의 보유와 관련한 법령을 준수합니다.
- 회원의 삭제 요청이 있는 경우 해당 정보는 즉시 삭제합니다.
- 12개월 이상 서비스를 미사용한 경우 회원의 개인정보는 12개월 경과 시 삭제합니다.

※ 회원은 개인정보 수집 및 이용에 동의하지 않을 수 있습니다. 그러나 서비스 제공에 필요한 개인정보 수집에 동의하지 않을 경우 서비스 이용이 불가능합니다.`


export const serviceTerm = `AppCatch 서비스 이용 약관


제 1장 총칙
제 1 조 (목적)
이 이용약관은 “AppCatch (이하 "당 사이트")”에서 제공하는 인터넷 서비스(이하 '서비스')의 가입조건, 당 사이트와 이용자의 권리, 의무, 책임사항과 기타 필요한 사항을 규정함을 목적으로 합니다.

제 2 조 (용어의 정의)
1. "이용자"라 함은 당 사이트에 접속하여 이 약관에 따라 당 사이트가 제공하는 서비스를 받는 회원을 말합니다.
2. "회원"이라 함은 서비스를 이용하기 위하여 당 사이트에 개인정보를 제공하여 아이디(ID)와 비밀번호를 부여 받은 자를 말합니다.
3. "회원 아이디(ID)"라 함은 회원의 식별 및 서비스 이용을 위하여 자신이 선정한 e-mail 주소를 말합니다.
4. "비밀번호"라 함은 회원이 자신의 개인정보 및 직접 작성한 비공개 콘텐츠의 보호를 위하여 선정한 문자, 숫자 및 특수문자의 조합을 말합니다.
...
3. 서비스의 이용은 연중무휴, 1일 24시간을 원칙으로 하며, 서비스 응대 및 처리 시간은 법정 근무일 근무시간(10:00~18:00, 법정공휴일 및 주말 제외)으로 합니다. 다만, 당 사이트의 업무상 또는 기술상의 이유로 서비스가 일시 중지 될 수 있습니다. 이러한 경우 당 사이트는 사전 또는 사후에 이를 공지합니다.
...
[부 칙]
(시행일) 이 약관은 2011년 11월 30일부터 적용되며, 종전 약관은 본 약관으로 대체되며, 개정된 약관의 적용일 이전 가입자도 개정된 약관의 적용을 받습니다.`
